...
namespace DABSquared\PushNotificationsBundle\DependencyInjection\Compiler;
...
class AddHandlerPass implements CompilerPassInterface
{
    ...
    {
        $service = $container->getDefinition("dab_push_notifications");

        foreach ($container->findTaggedServiceIds("dab_push_notifications.handler") as $id => $attributes) {
            ...
            // Required interface
            $requiredInterface = 'DABSquared\\PushNotificationsBundle\\Service\\OS\\OSNotificationServiceInterface';
